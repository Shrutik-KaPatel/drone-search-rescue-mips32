...
HD_PWD='F:/Vivado/Drone/Drone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipe_MIPS32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipe_MIPS32.tcl -notrace
