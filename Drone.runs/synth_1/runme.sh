...
HD_PWD='F:/Vivado/Drone/Drone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipe_MIPS32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipe_MIPS32.tcl
