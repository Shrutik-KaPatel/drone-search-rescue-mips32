...
REM
REM Generated by Vivado on Tue Mar 10 12:03:14 -0400 2026
...
echo "xvlog --incr --relax -prj pipe_MIPS32_tb_vlog.prj"
call xvlog  --incr --relax -prj pipe_MIPS32_tb_vlog.prj -log xvlog.log
